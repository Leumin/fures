...
from .views.restaurante import restauranteshtml,ver_restaurantes, ver_restaurante, crear_restaurante, actualizar_restaurante
...
urlpatterns = [
    ...
    #RESTAURANTE
    path('restaurante/restaurantes.html',restauranteshtml),
